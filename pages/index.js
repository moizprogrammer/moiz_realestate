...
<Image  src={imageUrl} height={500} width={500} alt="banner"/>
<Box p="5">
  <Text color="gray.500" fontSize="sm" fortWeight="medium">{purpose}</Text>
  <Text fontSize="3xl" fortWeight="bold">{title1} <br/>{title2}</Text>
